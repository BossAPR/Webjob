...
if ($id) {
    ...
    $query = "SELECT job_mail, company_name , job_name FROM job_ad WHERE job_ad_id = ?";
    ...
    if ($row) {
        ...
        $mail->Body = 'สวัสดีครับคุณ ' . $name . ' ,<br><br>เกี่ยวกับงาน '. $job_name .' เรามีเรื่องที่ต้องการติดต่อคุณ หากได้รับข้อความแล้ว<br>โปรดติดต่อกลับทางอีเมลข้างต้น<br><br>ทีมงาน';
