...
<head>
    ...
    .popup-content {
        ...
        text-align: center;
        position: relative;
        /* Add relative positioning for the close button */
        display: flex;
        flex-direction: column;
        align-items: center;
        justify-content: space-between;
        /* จัดปุ่มให้ห่างจากกัน */
    }
    ...
    .close-btn {
        ...
        top: 10px;
        right: 10px;
        /* ปรับขนาดตำแหน่งให้ "X" อยู่ในมุมขวา */
        cursor: pointer;
    }
    ...
    <div class="job-detail-container">
        <div class="job-detail">
            ...
            <div class="job-info">
                ...
                <!--p><strong>ความเหมาะสม: </strong><!?php
        ...
        <br>
        <center>
            <form action="send_applicationbyAI.php" method="POST" id="applicationForm">
                ...
                <input type="hidden" name="Suitability" value="<?= htmlspecialchars($suitability_score) ?>">
                <button type="button" name="apply" class="apply-button" id="apply-button">สมัครงาน</button>
            </form><br>
        </center>
        ...
        <a href="af_job_searchbyAI.php" class="back-link">กลับไปยังหน้าบอร์ดหางาน</a>
    </div>
                ...
                if (isProfileComplete) {
                    ...
                    setTimeout(() => {
                        applicationForm.action =
                            'send_applicationbyAI.php'; // ระบุ action ของฟอร์ม
                    ...
                    setTimeout(() => {
                        window.location.href =
                            'edit_profile.php'; // เปลี่ยนไปที่หน้า edit_profile.php
                    }, 500); // หน่วงเวลา 500 มิลลิวินาที (0.5 วินาที)
                }
            });
        }
