...
if (isset($_GET['job_name']) || isset($_GET['job_type']) || isset($_GET['job_province']) || isset($_GET['job_district'])) {
    ...
    if ($result->num_rows > 0) {
        while ($items = $result->fetch_assoc()) {
            // คำนวณความเหมาะสมสำหรับแต่ละงาน
            //$suitability = calculateSuitability($applicant_data, $items);
            ...
            ?>
                    ...
                    ?>
                        ...
                        <!--td>
                            <a>ความเหมาะสม: <!?php echo $suitability; ?>%</a><br>
                        </td-->
                        ...
                        <td>
                            <a href="af_job_detail.php?job_id=<?= htmlspecialchars($items['job_ad_id']); ?>"
        ...
        <section class="menu section bd-container" id="menu">
            ...
            <div class="menu__container bd-grid">
                ...
                //$suitability = calculateSuitability($applicant_data, $job);
                    ...
                    <a href="af_job_detail.php?job_id=<?php echo htmlspecialchars($job['job_ad_id']); ?>"
