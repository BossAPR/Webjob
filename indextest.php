...
<section class="menu section bd-container" id="menu">
        ...
        <?php if (!empty($recommended_jobs)): ?>
            <?php foreach ($recommended_jobs as $job): ?>
                <div class="menu__content">
                    <img src="assets/account_images/<?php echo htmlspecialchars($job['job_logo']); ?>" alt="" class="menu__img">
                    <h3 class="menu__name"><?php echo htmlspecialchars($job['job_name']); ?></h3>
                    <span class="menu__detail"><strong>ลักษณะงาน:</strong>
                        <?php if ($job['job_type'] == 1 || $job['job_type'] == 'งานประจำ') {
                            echo 'งานประจำ';
                    ...
                    <a href="af_job_detail.php?job_id=<?php echo htmlspecialchars($job['job_ad_id']); ?>" class="button menu__button">รายละเอียดเพิ่มเติม</a>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
    ...
    <script>
    // Populate profile data into edit_profile.html
    document.getElementById('full-name').innerText = '<?php echo $name; ?>';
    document.getElementById('birthday').innerText = '<?php echo $birthday; ?>';
    document.getElementById('gender').innerText = '<?php echo $gender; ?>';
    document.getElementById('addresses').innerText = '<?php echo $addresses; ?>';
    document.getElementById('account_email').innerText = '<?php echo $email; ?>';
    document.getElementById('phone').innerText = '<?php echo $phonenumbers; ?>';
    </script>
